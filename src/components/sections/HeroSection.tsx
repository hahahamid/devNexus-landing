...
const HeroSection = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage:
          "linear-gradient(to bottom, rgba(26, 31, 44, 0.97), rgba(26, 31, 44, 0.97)), url('https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&q=80&w=2072&ixlib=rb-4.0.3')",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fade-in">
            ...
            <p className="text-lg text-white/80 max-w-lg">
              We craft powerful, scalable web solutions that drive business
              growth and elevate your online presence. From CRM systems to
              stunning websites, we've got you covered.
            </p>
          ...
          <div className="relative animate-fade-in-slow">
            <div className="bg-dark-card glass-card p-6 rounded-lg shadow-xl purple-glow-sm">
              ...
              >
                <div>
                  <span className="text-purple-light">import</span>{" "}
                  <span className="text-highlight">
                    &#123; createApp &#125;
                  </span>{" "}
                  <span className="text-purple-light">from</span>{" "}
                  <span className="text-green-400">'@devnexus/core'</span>;
                </div>
                <div className="mt-2">
                  <span className="text-purple-light">const</span>{" "}
                  <span className="text-yellow-300">app</span>{" "}
                  <span className="text-white">=</span>{" "}
                  <span className="text-highlight">createApp</span>
                  <span className="text-white">(</span>
                  <span className="text-white">&#123;</span>
                </div>
                <div className="ml-4">
                  <span className="text-blue-300">name</span>:{" "}
                  <span className="text-green-400">'Your Amazing Project'</span>
                  ,
                </div>
                <div className="ml-4">
                ...
                <div className="mt-2">
                  <span className="text-highlight">app</span>.
            ...
            <div
              className="absolute -bottom-5 -left-5 w-16 h-16 rounded-full bg-dark-card border border-purple/30 flex items-center justify-center animate-float"
